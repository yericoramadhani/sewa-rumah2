                        ...
                        <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <input type="text" class="form-control mb-2" name="harga" value="{{ $item->harga}}" id="defaultFormControlInput" placeholder="Harga" aria-describedby="defaultFormControlHelp" />
